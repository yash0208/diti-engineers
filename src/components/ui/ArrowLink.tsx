...
export function ArrowLink({
  ...
  const sharedClass = cn(
    "inline-flex h-10 max-h-10 items-center justify-center gap-2 overflow-hidden rounded-sm px-4 text-base interactive-press interactive-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2",
    isLight
