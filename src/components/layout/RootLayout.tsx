...
const FOOTERLESS_ROUTES = ["/", "/about", "/machinery", "/products", "/services", "/blog", "/buyers", "/factory", "/certificate", "/contact"] as const;
const LOCKED_SCROLL_ROUTES = ["/machinery", "/products", "/blog", "/buyers", "/contact"] as const;
